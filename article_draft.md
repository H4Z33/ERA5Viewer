...
To resolve these trend behaviors in their chronological context, we also overlaid the fitted linear regression lines as localized segments directly onto the continuous 1998–2025 CHSI time series as a unified, single-panel chronological timeline (Figure 10). In this unified representation, if a wet extreme event (flood or hurricane) occurs during a drought period—such as Hurricane Keith (F1) in October 2000 falling within the 1998–2003 drought (D1)—it divides the drought period into separate segments (e.g., D1a: 1998-01-01 to 2000-09-30, and D1b: 2000-10-16 to 2003-12-31) for independent trend estimation. The unified plot overlays the independent regression slopes for all divided drought segments (red), the non-drought baseline segments (blue), and the 2-year pre-flood (orange) and post-flood (teal) lead/lag windows directly on the same timeline axis.
